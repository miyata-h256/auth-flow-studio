...
パスワードなしで、メールだけで安全にログインできました。`,
    ...
    oidcStepUI: {
        ...
        goHome: 'ホームに戻る',
        clientBuildsAuthRequest: 'クライアントは Authorization Request を組み立てます。',
        mockLoginForm: 'ログインフォーム（擬似）',
        mockBrowserUrl: 'ブラウザの URL（擬似）',
        queryContainsCodeState: 'クエリには code と state が含まれています。',
        csrfMismatchAbort: '一致しなければ CSRF 攻撃の疑いがあり、処理を中断します。',
        mockLoginStatus: 'ログイン状態（サンプル）',
        accessTokenUsedForApi: '以降のリクエストでは Access Token が API 呼び出しなどに使われます。',
        oidcFlowComplete: 'ここまでが OIDC Code Flow の大まかな流れです。',
    },
