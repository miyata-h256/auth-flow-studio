// src/flows/magic/MagicFlowSvg.tsx
            ...
            <g transform='translate(10, 0)'>
                ...
                >
                    ...
                    <polygon
                        ...
                        points={`${X.FE - 2},${stepY[1]} ${X.FE - 14},${stepY[1] - 4} ${X.FE - 12
                ...
                >
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.API - 2},${stepY[2]} ${X.API - 14},${stepY[2] - 4} ${X.API - 12
                ...
                <g
                    data-step-arrow='3'
                    className={`${styles.arrowGroup} ${activeStep === 3 ? styles.arrowRightActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.DB - 2},${stepY[3]} ${X.DB - 14},${stepY[3] - 4} ${X.DB - 12
                ...
                <g
                    data-step-arrow='4'
                    className={`${styles.arrowGroup} ${activeStep === 4 ? styles.arrowLeftActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.API + 2},${stepY[4]} ${X.API + 14},${stepY[4] - 4} ${X.API + 12
                ...
                <g
                    data-step-arrow='5'
                    className={`${styles.arrowGroup} ${activeStep === 5 ? styles.arrowRightActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.S - 2},${stepY[5]} ${X.S - 14},${stepY[5] - 4} ${X.S - 12
                ...
                <g
                    data-step-arrow='6'
                    className={`${styles.arrowGroup} ${activeStep === 6 ? styles.arrowLeftActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.API + 2},${stepY[6]} ${X.API + 14},${stepY[6] - 4} ${X.API + 12
                ...
                <g
                    data-step-arrow='7'
                    className={`${styles.arrowGroup} ${activeStep === 7 ? styles.arrowRightActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.MAIL - 2},${stepY[7]} ${X.MAIL - 14},${stepY[7] - 4} ${X.MAIL - 12
                ...
                >
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.API + 2},${stepY[8]} ${X.API + 14},${stepY[8] - 4} ${X.API + 12
                ...
                >
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.FE + 2},${stepY[9]} ${X.FE + 14},${stepY[9] - 4} ${X.FE + 12
                ...
                <g
                    data-step-arrow='10'
                    className={`${styles.arrowGroup} ${activeStep === 10 ? styles.arrowLeftActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.U + 2},${stepY[10]} ${X.U + 14},${stepY[10] - 4} ${X.U + 12
                ...
                <g
                    data-step-arrow='11'
                    className={`${styles.arrowGroup} ${activeStep === 11 ? styles.arrowRightActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.MAIL - 2},${stepY[11]} ${X.MAIL - 14},${stepY[11] - 4
                ...
                <g
                    data-step-arrow='12'
                    className={`${styles.arrowGroup} ${activeStep === 12 ? styles.arrowRightActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.FE - 2},${stepY[12]} ${X.FE - 14},${stepY[12] - 4} ${X.FE - 12
                ...
                <g
                    data-step-arrow='13'
                    className={`${styles.arrowGroup} ${activeStep === 13 ? styles.arrowRightActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.API - 2},${stepY[13]} ${X.API - 14},${stepY[13] - 4} ${X.API - 12
                ...
                <g
                    data-step-arrow='14'
                    className={`${styles.arrowGroup} ${activeStep === 14 ? styles.arrowRightActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.S - 2},${stepY[14]} ${X.S - 14},${stepY[14] - 4} ${X.S - 12
                ...
                <g
                    data-step-arrow='15'
                    className={`${styles.arrowGroup} ${activeStep === 15 ? styles.arrowLeftActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.API + 2},${stepY[15]} ${X.API + 14},${stepY[15] - 4} ${X.API + 12
                ...
                <g
                    data-step-arrow='16'
                    className={`${styles.arrowGroup} ${activeStep === 16 ? styles.arrowLoopUp : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                ...
                <g
                    data-step-arrow='16'
                    className={`${styles.arrowGroup} ${activeStep === 16 ? styles.arrowLoopDown : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.API - 40},${stepY[16] + 13} ${X.API - 31},${stepY[16] + 17
                ...
                <g
                    ...
                    {...(interactive && {
                        ...
                        role: 'button',
                        tabIndex: 0,
                        onKeyDown: (e: React.KeyboardEvent<SVGGElement>) => e.key === 'Enter' && handleStepClick?.(e),
                    })}
                >
                    <circle
