// src/flows/passkey/PasskeyFlowSvg.tsx
import React from 'react';
import styles from './styles/PasskeyFlowSvg.module.css';
import { PASSKEY_STEPS } from './passkeySteps';
import type { FlowStepWithType } from '../../types';

/**
 * PasskeyFlowSvg コンポーネントのProps
 */
interface PasskeyFlowSvgProps {
    activeStep: number;
...
export default function PasskeyFlowSvg({
    ...
    const handleStepClick: React.MouseEventHandler<SVGGElement> | undefined = interactive
        ? (e) => {
    ...
    // キーボードイベントハンドラ
    const handleKeyDown: React.KeyboardEventHandler<SVGGElement> | undefined = interactive
        ? (e) => {
            if (e.key === 'Enter') {
                const stepId = parseInt(e.currentTarget.dataset.step ?? '', 10);
                if (stepId && onStepClick) {
            ...
            <g>
                ...
                >
                    ...
                    <polygon
                        ...
                        points={`${X.FE},${stepY[1]} ${X.FE - 23},${stepY[1] + 5} ${X.FE - 20
                ...
                >
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.BE},${stepY[2]} ${X.BE - 20},${stepY[2] + 5} ${X.BE - 17
                ...
                >
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.FE},${stepY[3]} ${X.FE + 20},${stepY[3] - 5} ${X.FE + 17
                ...
                >
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.AUTH},${stepY[4]} ${X.AUTH - 20},${stepY[4] + 5} ${X.AUTH - 17
                ...
                >
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.USER},${stepY[5]} ${X.USER + 20},${stepY[5] - 5} ${X.USER + 17
                ...
                >
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.AUTH},${stepY[6]} ${X.AUTH - 20},${stepY[6] + 5} ${X.AUTH - 17
                ...
                <g
                    data-step-arrow='7'
                    className={`${styles.arrowGroup} ${activeStep === 7 ? styles.arrowLeftActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.FE},${stepY[7]} ${X.FE + 20},${stepY[7] - 5} ${X.FE + 18
                ...
                <g
                    data-step-arrow='8'
                    className={`${styles.arrowGroup} ${activeStep === 8 ? styles.arrowRightActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.BE},${stepY[8]} ${X.BE - 25},${stepY[8] + 5} ${X.BE - 20
                ...
                <g
                    data-step-arrow='9'
                    className={`${styles.arrowGroup} ${activeStep === 9 ? styles.arrowLoopUp : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                ...
                <g
                    data-step-arrow='9'
                    className={`${styles.arrowGroup} ${activeStep === 9 ? styles.arrowLoopDown : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.BE - 51},${stepY[9] + 15} ${X.BE - 42},${stepY[9] + 19
                ...
                <g
                    data-step-arrow='10'
                    className={`${styles.arrowGroup} ${activeStep === 10 ? styles.arrowLoopUp : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                ...
                <g
                    data-step-arrow='10'
                    className={`${styles.arrowGroup} ${activeStep === 10 ? styles.arrowLoopDown : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.BE - 51},${stepY[10] + 15} ${X.BE - 42},${stepY[10] + 19
                ...
                <g
                    data-step-arrow='11'
                    className={`${styles.arrowGroup} ${activeStep === 11 ? styles.arrowLoopUp : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                ...
                <g
                    data-step-arrow='11'
                    className={`${styles.arrowGroup} ${activeStep === 11 ? styles.arrowLoopDown : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.BE - 50},${stepY[11] + 15} ${X.BE - 41},${stepY[11] + 19
                ...
                <g
                    data-step-arrow='12'
                    className={`${styles.arrowGroup} ${activeStep === 12 ? styles.arrowLeftActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.FE},${stepY[12]} ${X.FE + 20},${stepY[12] - 5} ${X.FE + 17
                ...
                <g
                    data-step-arrow='13'
                    className={`${styles.arrowGroup} ${activeStep === 13 ? styles.arrowLeftActive : ''
                        }`}
                >
                    <line
                        className={styles.arrow}
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.USER},${stepY[13]} ${X.USER + 20},${stepY[13] - 5} ${X.USER + 17
                ...
                >
                    ...
                    <polygon
                        className={styles.arrowHead}
                        points={`${X.FE},${stepY[14]} ${X.FE - 20},${stepY[14] + 5} ${X.FE - 15
