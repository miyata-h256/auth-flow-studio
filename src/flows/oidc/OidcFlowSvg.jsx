...
export default function OidcFlowSvg({ activeStep }) {
  return (
    ...
    >
      ...
      {/* Step 9: Client → API Server (Request with Access Token) */}
      <g
        data-step-arrow='9'
        className={`${styles.arrowGroup} ${
      ...
      >
        ...
        <polygon
          className={styles.arrowHead}
          points='835,555 814,559 816,555 814,551'
        />
      </g>

      {/* Step 10: API Server → Client (Response) */}
      <g
        data-step-arrow='10'
        className={`${styles.arrowGroup} ${
      ...
      >
        ...
        <polygon
          className={styles.arrowHead}
          points='330,605 352,601 350,605 352,609'
        />
      </g>
